...
<body>
    <section class="mx-5">
        <div class="signupform mx-5 h-75 mb-3">
            ...
            <p>Already have an account ?<a class="text-warning" href="login.php">Log in</a></p>
            <button type="submit" class="btn btn-warning rounded-pill text-light fw-semibold px-4">Sign up</button></div>
            </form>
        </div>
        </div>
    </section>
